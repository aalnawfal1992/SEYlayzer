...
public class execute_CL {
    ...
    public void startCMD(Event e) throws IOException {
        ...
        for(int i = 0; i < my_nodes.size(); i++) {
            ...
            String cmd = "/usr/local/bin/bwa mem -t " + cpu + " " + firstPath + " " + secondPath + " " + thirdPath + " " + "> " + outputPath + ".sam";
            //String cmd = "echo A";
            ...
            //Remove Clonal reads
            //String cmd4 = "/usr/local/bin/sambamba markdup -t " + cpu + " -r " + " " + outputPath + "_Sorted.bam" + " " + outputPath + "_PCRFree.bam";
            //String cmd4 = "echo D";
            ...
            //try {
              //  process4 = pb4.start();
               // InputStreamReader isReader = new InputStreamReader(process4.getInputStream());
               // BufferedReader reader = new BufferedReader(isReader);
               // StringBuffer sb = new StringBuffer();
               // String str;
               // while((str = reader.readLine())!= null){
           ...
           // } catch (IOException | InterruptedException ex) {
            ...
            //Varients Calling
            //String cmd7 = "python3 /Users/abdullahalnawfal/Downloads/gatk-4.4.0.0/gatk HaplotypeCaller --native-pair-hmm-threads " + cpu + " -I " + outputPath + "_PCRFree.bam" + " -O " + outputPath + ".vcf" + " -R " + firstPath + " -L " + bedPath;
